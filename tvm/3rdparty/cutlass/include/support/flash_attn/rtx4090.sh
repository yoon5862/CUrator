...
nvcc flash_attn.cu -arch=sm_80 --std=c++17 -Xcompiler -fPIC -shared -I/home/5862www/curator/tvm/3rdparty/cutlass/include/support/cutlass-3.5.1/include -o flash_attn.so --expt-relaxed-constexpr --expt-extended-lambda -O3 -use_fast_math
