...
def instantiate_fmha_template(attrs, func_args, torch_var1, func_name):
  ...
  aux_map.update({"output_accum_ptr": "p.logsumexp_ptr = nullptr;"}) if len(func_args) < 7 else aux_map.update({"output_accum_ptr": "p.output_accum_ptr = (ElementInputA*)(${arg6}->data);\n"})
